...
?>
													...
													<div class="stat-panel-title text-uppercase">Total Tenants</div>
												</div>
											</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql3 ="SELECT id from room";
$query3 = $dbh -> prepare($sql3);
$query3->execute();
$results3=$query3->fetchAll(PDO::FETCH_OBJ);
$bg3=$query3->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($bg3);?></div>
													<div class="stat-panel-title text-uppercase">Total Rooms</div>
												</div>
											</div>
											<a href="roomlist.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql6 ="SELECT id from deletetenant";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Deleted Tenants</div>
												</div>
											</div>
											<a href="deletedtenant.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
