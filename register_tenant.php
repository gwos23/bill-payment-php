...
$sql ="INSERT INTO tenants (name, email, password, gender, mobile, roomtype, image, status) VALUES(:name, :email, :password, :gender, :mobileno, :roomtype, :image, 1)";
...
echo "<script type='text/javascript'> document.location = 'View_tenant.php'; </script>";
}
else 
{
